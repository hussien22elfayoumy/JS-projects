...
const account1 = {
  ...
  movementsDates: [
    ...
    '2020-07-25T14:11:59.604Z',
    '2024-07-26T17:01:17.194Z',
    '2024-07-27T23:36:17.929Z',
    '2024-07-28T10:51:36.790Z',
  ],
  currency: 'EUR',
  locale: 'pt-PT', // de-DE
};
...
const formateCur = (value, locale, cur) => {
...
const startLogOutTimer = function () {
  ...
  const tick = function () {
    ...
    // In eack call, print the remainig time to UI
...
/* const calcAge = function (year, month, day) {
  ...
  return `You have ${years} Years | ${months} Months | ${days} days`;
};

console.log(calcAge(2000, 8, 14)); */
